...
function listProjects (req, res) {
  Project.find((err, projectsArray) => {
    ...
    for (let i = 0; i < projectsArray.length; ++i) {
      simplifiedList.push({_id: projectsArray[i].id, title: projectsArray[i].title, description: projectsArray[i].description, github: projectsArray[i].github, website: projectsArray[i].website, image: projectsArray[i].image1})
    }
